...
options = pd.read_csv("OUTPUT/OP_MOD" + START_DATE + "_" + END_DATE + ".csv")
analysis_end = "2023-02-28" # date want to end for analysis
...
bayes_beta.to_csv("OUTPUT/bayes_beta_nike.csv")
